...
def test_day7_part2_example():
    assert solve_day7_part2("""faded blue bags contain no other bags.
dotted black bags contain no other bags.
vibrant plum bags contain 5 faded blue bags, 6 dotted black bags.
dark olive bags contain 3 faded blue bags, 4 dotted black bags.
shiny gold bags contain 1 dark olive bag, 2 vibrant plum bags.""") == 32
    assert solve_day7_part2("""shiny gold bags contain 2 dark red bags.
